...
excerpt: 'This study examined cadmium loss from acidic red soil under simulated rainfall (60 and 120 mm·h⁻¹) with 0–7% biochar addition, showing that biochar generally reduced Cd availability and runoff- plus sediment-borne Cd loss, while excessively high application (7%) under intense rainfall could aggravate erosion and Cd export.'
share: false
---

## DOI

[https://doi.org/10.1007/s11356-022-21623-x](https://doi.org/10.1007/s11356-022-21623-x)
...
Yuan, Z., Song, Y., Li, D., Huang, B., Chen, Y., **Ge, X.**, ... & Xie, Z. (2022). Effects of biochar application on the loss characteristics of Cd from acidic soil under simulated rainfall conditions. Environmental Science and Pollution Research, 29(55), 83969-83980.
